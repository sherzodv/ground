...
In general we want to keep templates layer dumb: simple foreach, ifs, no new concepts are created in it. All necessary low level details we want to have in vendor layer.
